...
public class entity_areYouSure extends engine_entity {
	...
	public void sys_step() {
		...
		popup_alpha += (popup_alpha_target - popup_alpha) * 5f * ref.main.time_scale;
	...
	public void setPopupStateHard(boolean open) {
		popup_open = open;
		popup_alpha_target = open ? 1 : 0;
		popup_alpha = popup_alpha_target;
		...
		switch (action) {
			...
			case STATE_ABANDON:
				if (yes_or_no_action) {
					...
					mgr.gameMain.floor_height_target = ref.screen_height;
				} else {
