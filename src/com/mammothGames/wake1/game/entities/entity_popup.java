...
//		button_h = mgr.menuDifficulty.button_height - mgr.menuDifficulty.button_border_size;
		...
		float button_height = mgr.menuDifficulty.button_height - mgr.menuDifficulty.button_border_size;
		...
		float button_y = -draw_width/2 + button_height/2;
		...
		ref.draw.drawText(draw_x-button_x, draw_y+button_y, mgr.gameMain.text_size, ref.draw.X_ALIGN_CENTER, ref.draw.Y_ALIGN_CENTER, constants.layer7_overHUD, textures.TEX_FONT1);
