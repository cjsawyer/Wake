...
public class entity_loadingDebug extends engine_entity {
	...
	public void sys_step() {
		...
		ref.draw.drawCircle(ref.screen_width/2, ref.screen_height/2, ref.screen_width/4, 0, 0, 360, 0, 1);
		
		ref.draw.setDrawColor(1, 1, 1, 1);
		ref.draw.drawCircle(ref.screen_width/2, ref.screen_height/2, ref.screen_width/5, 0, 0, angle, 0, 2);
