...
public class entity_loadingTest extends engine_entity {
	...
	public void sys_step(){
		...
		ref.draw.drawTexture(ref.screen_width/2, ref.screen_height/2, 300, 300, 0, 0, angle, 0, 1, game_textures.TEX_ERROR);
		angle += 60 * ref.main.time_scale;
		
		ref.draw.drawTexture(100, ref.screen_height/2, 100, 100, 0, 0, 0, 0, 1, game_textures.TEX_ERROR);
		ref.draw.drawTexture(ref.screen_width/3+100, ref.screen_height/2, 100, 100, 0, 0, 0, 0, 1, game_textures.TEX_ERROR);
		ref.draw.drawTexture(ref.screen_width*2/3+100, ref.screen_height/2, 100, 100, 0, 0, 0, 0, 2, game_textures.TEX_FONT1);
